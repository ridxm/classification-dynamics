...
def load_training_data(train_size=500, val_size=500, traj_dir='trajectories'):
    """
...
def load_test_data(test_start_index=500, traj_dir='trajectories', feature_max=None):
    """
