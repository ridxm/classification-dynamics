"""
Load and preprocess cartpole-pybullet trajectory data.
...
For 100 training and 100 validation trajectories.
"""
...
def load_trajectory_data(train_size=100, val_size=100):
    """
    ...
    Args:
        train_size: Number of sequences for training (default: 100)
        val_size: Number of sequences for validation (default: 100)
    ...
    print(f"Features: 4 features (cartpole-pybullet)")
    print(f"  Feature structure: [0]=x (cart position), [1]=theta (pole angle), [2]=x_dot (cart velocity), [3]=theta_dot (pole angular velocity)")
...
def save_processed_data(train_data, val_data,
                       train_filename="trajectory_data_train_100.npz",
                       val_filename="trajectory_data_val_100.npz"):
...
if __name__ == "__main__":
    train_data, val_data = load_trajectory_data(train_size=100, val_size=100)
