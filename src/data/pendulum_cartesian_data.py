"""Pendulum Cartesian data loading module."""
...
class PendulumCartesianDataModule(BaseClassifierDataModule):
    """DataModule for Pendulum Cartesian system."""
    ...
    def load_data_file(
        ...
        """Load Pendulum Cartesian trajectory data.
    ...
    def _load_individual_datapoints(
        ...
        for idx, seq_file in enumerate(sequence_files):
            ...
            # Break into datapoints (no transformation)
